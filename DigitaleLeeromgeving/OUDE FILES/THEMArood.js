...
// html {
//   background-image: url(css/Images/achtergrondROOD.png);
...
// #knopaan {
//   background-image: url(Images/knopAdd.jpg);
//   width:100px;
//   height:100px;
//   border-radius:5px;
//   padding-top:73px;
...
// #knopuit {
//   background-image: url(Images/knopRmv.jpg);
//   width:100px;
//   height:100px;
//   border-radius:5px;
//   padding-top:73px;
...
// .front {
//   background: #FFFFFF url('Images/obaLogoJunior.png') no-repeat center center / contain;
// }
